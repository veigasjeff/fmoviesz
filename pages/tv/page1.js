...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://fmoviesz.vercel.app/tv/page1',
  headline: 'Watch Tv Show Page 1 | FMovies™',
  url: 'https://fmoviesz.vercel.app/tv/page1',
  description:
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://fmoviesz.vercel.app/tv/pge1'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://fmoviesz.vercel.app/tv/page1'
    }
  ]
})
...
const Page1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Tv Show Page 1 | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/tv/page1' />
        <meta
          name='robots'
        ...
        <meta
          property='og:title'
          content=' Watch Tv Show Page 1 | FMovies™'
        />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/tv/page1' />
