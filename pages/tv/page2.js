...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://fmoviesz.vercel.app/tv/page2',
  headline: 'Watch Tv Show Page 2 | FMovies™',
  url: 'https://fmoviesz.vercel.app/tv/page2',
  description:
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://fmoviesz.vercel.app/tv/pge2'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://fmoviesz.vercel.app/tv/page2'
    }
  ]
})
...
const Page2 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title>Watch Tv Show Page 2 | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/tv/page2' />
        <meta
          name='robots'
        ...
        <meta
          property='og:title'
          content=' Watch Tv Show Page 2 | FMovies™'
        />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/tv/page2' />
        ...
        />
        <meta name='keywords' content='fmovies, fmovieswatch, fmovies free, fmovies apk, fmovies hd, fmovies id, fmovies rs, fmovies movies, official fmovies, fmovies free, free movies, movies online, watch movies online, watch movies free, 123movies, fmovies, putlocker, putlockers, hdtoday' />
        <meta
          property='og:image'
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://fmoviesz.vercel.app/tvshowp4.json')
