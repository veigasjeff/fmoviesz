...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://fmoviesz.vercel.app/ad/page2',
  headline: 'Watch Adult Movies Page 2 | FMovies ™',
  url: 'https://fmoviesz.vercel.app/ad/page2',
  description:
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://fmoviesz.vercel.app/ad/pge2'
  },
  additionalProperty: {
    '@type': 'PropertyValue',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Movies',
      item: 'https://fmoviesz.vercel.app/ad/page2'
    }
  ]
})
...
const Page2 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Adult Movies Page 2 | FMovies ™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/ad/page2' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Adult Movies Page 2 | FMovies ™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/ad/page2' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://fmoviesz.vercel.app/adultp3.json')
