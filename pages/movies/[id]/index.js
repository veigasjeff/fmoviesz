  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${movieszipItem.name} | FMovies™`,
      ...
      },
      {
        ...
        headline: ` ${movieszipItem.name} | FMovies™`,
        datePublished: movieszipItem.datePublished,
        dateModified: movieszipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {movieszipItem.name} | FMovies™</title>
        ...
        <meta
          property='og:title'
          content={`${movieszipItem && movieszipItem.name} - FMovies™`}
        />
        <meta
          property='og:description'
          content='Stream HD movieszipItems and TV series for free on FMovies™. Online. Stream. Download. full-length movieszipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${movieszipItem.title} available on FMovies™. Enjoy free streaming of full-length movieszipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
        ...
        <meta
          ...
          content={`${movieszipItem && movieszipItem.group}`}
        />
