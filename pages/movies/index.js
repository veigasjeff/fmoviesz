...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://fmoviesz.vercel.app/movies/',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Movie',
      item: 'https://fmoviesz.vercel.app/movies/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Movies | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Movies | FMovies™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/movies' />
