  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${tvshowzipItem.name} | FMovies™`,
      ...
      },
      {
        ...
        headline: ` ${tvshowzipItem.name} | FMovies™`,
        datePublished: tvshowzipItem.datePublished,
        dateModified: tvshowzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {tvshowzipItem.name} | FMovies™</title>
        ...
        <meta
          property='og:title'
          content={`${tvshowzipItem && tvshowzipItem.name} - FMovies™`}
        />
        <meta
          property='og:description'
          content='Stream HD tvshowzipItems and TV series for free on FMovies™. Online. Stream. Download. full-length tvshowzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${tvshowzipItem.title} available on FMovies™. Enjoy free streaming of full-length tvshowzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
        ...
        <meta
          ...
          content={`${tvshowzipItem && tvshowzipItem.group}`}
        />
