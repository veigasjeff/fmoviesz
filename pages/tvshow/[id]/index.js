      ...
      >
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>FMovies </strong> ensures that you won't miss a single moment
              of the action, drama, or comedy that makes this TV series a
              must-watch. With high-quality streaming and user-friendly
              navigation, <strong>FMovies </strong> provides everything you need to
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{moviesp1Item.title}</strong> on <strong>FMovies </strong> is
              ...
              <strong>FMovies </strong>, your favorite TV series is just a click
              away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>{moviesp1Item.title}</strong>. At <strong>FMovies </strong>,
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{moviesp1Item.title}</strong> on{' '}
              <strong>FMovies </strong> provides you with a user-friendly interface
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>FMovies </strong> is the trusted choice for adult content.
            </p>
          </>
        )}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              Streaming <strong>{moviesp1Item.title}</strong> on{' '}
              <strong>FMovies </strong> guarantees a seamless viewing experience
            ...
            <p className='text-lg bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent mt-4'>
              ...
              <strong>FMovies </strong>, your entertainment is just a click away.
            </p>
          </>
        )}
        <a
