...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://fmoviesz.vercel.app/adult',
  headline: 'Watch Adult Movies | FMovies™',
  url: 'https://fmoviesz.vercel.app/adult',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Adult',
      item: 'https://fmoviesz.vercel.app/adult'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Adult Movies | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/adult/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Adult Movies | FMovies™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/adult' />
