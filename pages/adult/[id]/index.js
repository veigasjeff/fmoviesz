  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${adultzipItem.name} | FMovies™`,
      ...
      },
      {
        ...
        headline: ` ${adultzipItem.name} | FMovies™`,
        datePublished: adultzipItem.datePublished,
        dateModified: adultzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {adultzipItem.name} | FMovies™</title>
        ...
        <meta
          property='og:title'
          content={`${adultzipItem && adultzipItem.name} - FMovies™`}
        />
        <meta
          property='og:description'
          content='Stream HD adultzipItems and TV series for free on FMovies™. Online. Stream. Download. full-length adultzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${adultzipItem.title} available on FMovies™. Enjoy free streaming of full-length adultzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
        ...
        <meta
          ...
          content={`${adultzipItem && adultzipItem.group}`}
        />
