...
const contact = () => {
  ...
  return (
    <div>
      <Head>
        <title>FMovies | Contact Us</title>
        ...
        />
        <link rel='canonical' href='https://fmoviesz.vercel.app/intro/contact' />
        ...
        <meta
          property='og:url'
          content='https://fmoviesz.vercel.app/intro/contact/'
        />
          ...
          <div className='flex flex-wrap'>
            <div className='grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6'>
              ...
              <p className='text-gray-500 mb-6'>
                ...
                related to FMovies. We welcome your input to help us echance
                our services and offerings.
              </p>

              <p className='text-gray-500 mb-6'>
                To submit your email the following details to{' '}
                <strong>FMovies@outlook.com</strong>:
              </p>
            </div>
