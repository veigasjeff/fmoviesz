...
const page3 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page3',
    headline: 'Page 3 | FMOVIES™',
    url: 'https://fmoviesz.vercel.app/page3',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page3'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 3 | FMOVIES™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page3' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 3 | FMOVIES™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page3' />
