...
const page5 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page5',
    headline: 'Page 5 | FMOVIES™',
    url: 'https://fmoviesz.vercel.app/page5',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page5'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 5 | FMOVIES™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 5 | FMOVIES™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page5' />
