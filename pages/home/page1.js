...
const page1 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page1',
    headline: 'Page 1 | FMovies™',
    url: 'https://fmoviesz.vercel.app/page1',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page1'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 1 | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page1' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 1 | FMovies™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page1' />
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://fmoviesz.vercel.app/moviesp12.json');
