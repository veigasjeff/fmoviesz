...
const page4 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page4',
    headline: 'Page 4 | FMovies™',
    url: 'https://fmoviesz.vercel.app/page4',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page4'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 4 | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page4' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 4 | FMovies™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page4' />
