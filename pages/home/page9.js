...
const page9 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page9',
    headline: 'Page 9 | FMovies™',
    url: 'https://fmoviesz.vercel.app/page9',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page9'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 9 | FMovies™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page9' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 9 | FMovies™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page9' />
