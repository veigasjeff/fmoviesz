...
const page6 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://fmoviesz.vercel.app/page6',
    headline: 'Page 6 | FMOVIES™',
    url: 'https://fmoviesz.vercel.app/page6',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://fmoviesz.vercel.app/page6'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 6 | FMOVIES™</title>
        <link rel='canonical' href='https://fmoviesz.vercel.app/page6' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 6 | FMOVIES™' />
        <meta
        ...
        <meta property='og:url' content='https://fmoviesz.vercel.app/page6' />
